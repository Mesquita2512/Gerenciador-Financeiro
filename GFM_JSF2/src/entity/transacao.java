...
public abstract class transacao {
	...
	protected double val_Transação;
	...
	public transacao(long cod_Transacao, String desc_Transacao, double val_Transação, Date date) {
		
		this.cod_Transacao = cod_Transacao;
		this.desc_Transacao = desc_Transacao;
		this.val_Transação = val_Transação;
		this.date = date;
	}
	...
	public double getVal_Transação() {
		return val_Transação;
	}

	public void setVal_Transação(double val_Transação) {
		this.val_Transação = val_Transação;
	}
